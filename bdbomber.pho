...
<div class="container">
    ...
    <form id="apiForm" method="POST" onsubmit="showPopup(); return false;">
        ...
        <button type="button" onclick="window.location.href='https://t.me/TAL4_U'">Join Telegram Channel</button>
    </form>
    <div id="message"></div>
    <div class="credit">
        <p>Credit: <a href="https://t.me/OGM010" target="_blank">OGM OWNER</a></p>
    </div>
</div>
